...
1. 입문용 클러스터
   - 용도: 코드 테스트, 소규모 계산, 수업용
   - 연산 서버: c7i.large × 최대 4대 / EFS

2. 전산 시뮬레이션 클러스터
   - 용도: FEM, CFD (ANSYS, OpenFOAM 등)
   - 연산 서버: c8i.48xlarge × 최대 8대 / FSx Lustre 1.2TB

3. AI/딥러닝 클러스터
   - 용도: 모델 학습, 데이터 분석
   - 연산 서버: g6.xlarge × 최대 8대 / FSx Lustre 1.2TB
